...
const Head = ({
  ...
  return (
    <Helmet>
      ...
      <link data-testid="head__canonical" rel="canonical" href={canonical} />

      <meta
        content={socialImageUrl || `${siteUrl}/social.png`}
        property="og:image"
      />
  ...
  <StaticQuery
    ...
    render={data => (
      <Location>
        {({ location }) => {
          return (
            <Head {...data.site.siteMetadata} location={location} {...props} />
          );
        }}
      </Location>
    )}
